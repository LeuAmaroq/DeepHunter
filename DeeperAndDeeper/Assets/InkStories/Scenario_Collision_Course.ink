...
===Collision_course===
‘Commander, we have some bad news.’ 
*What is it?
->next0

=next0
‘Our C02 scrubbers have malfunctioned. We must have missed it in our checks.’
...
=Surface
The sub finally breaches the surface. However, there’s no time to rest as we are in hostile waters. The lookout spots a ship in the distance.
~encounter = true
// Instantiate a ship image
...
=Wait
Finally, you receive confirmation of a confirmed hit. The oncoming vessel is slowed, but not stopped. The torpedo must have only glanced the hull.
->Further_action
...
=Critical_Hit
You hear the horrendous sound the ship's hull make as it breaches. The ship collapses in on itself and out spills its cargo and unfortunate crew. You salvage what you can.
// Collateral + 1
~ fuel = fuel + 1
~ torpedo = torpedo + 2
->Before_End
...
=Critical_Fail
With all the panic onboard your artillery managed to completely miss its target. As you give your orders to try to move away, you realise it is already to late to act. The bow of the ship strikes the tail of your submarine. 
* {hull >= 2} After the initial shock subsided, you are amazed to realise you were still in one piece. You assess the damage.
~ hull = hull - 1
~encounter = false
->Repair
...
=Stern
It seems like our way won't cross.
...
=Collision
As the repairs are underway, something doesn’t feel quite right. You look to check the distance of the other ship and it has moved closer to your position. What you saw must have been the bow. You are on a collision course!
* Evasive manoeuvers!  
->Hit
* {torpedo > 0} Fire torpedoes!
~ torpedo = torpedo - 1
...
=Hit
You begin to move away, but you were too late to act. The bow of the ship strikes the tail of your submarine. 
* {hull >= 2} After the initial shock subsided, you are amazed to realise you were still in one piece. You assess the damage.  
~ hull = hull - 1
~encounter = false
->Repair
...
* {crew < 1} There is no answer. Your remaining crew must not have made it.
->Game_Over



=Report
Unfortunately you lost a crew member. Your remaining crew manage to get the C02 scrubbers up and running again. There's no time to morn the dead. You still have your mission.
~encounter = false
->Before_End
...
~ torpedo = torpedo - 1
->Destroy_ship
* {torpedo < 1} We can't do anything with no torpedoes. Let's move to safety to repair the CO2 scrubbers.
~encounter = false
->Repair
